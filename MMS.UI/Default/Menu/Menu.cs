...
{
    public class NavigationMenu : System.Windows.Controls.Menu
    {
        ...
        public static readonly DependencyProperty MenuItemsProperty = DependencyProperty.Register("MenuItems", typeof(List<MenuItem>), typeof(NavigationMenu), null);
